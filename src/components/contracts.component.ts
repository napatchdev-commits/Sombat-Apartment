// ==========================================================================
// CONTRACTS COMPONENT (DEDICATED RENTAL CONTRACTS MANAGEMENT VIEW)
// ==========================================================================
...
export class ContractsComponent {
  public static render(state: DatabaseState): string {
    ...
    // Build contracts list from tenants & rooms data
    const contracts = tenants.map(t => {
      ...
      let status = 'active';
      let statusText = '🟢 มีผลบังคับใช้';
      let statusBadge = 'badge-success';

      if (diffDays < 0) {
        status = 'expired';
        statusText = '🔴 หมดอายุสัญญา';
                ...
                ${contracts.map(c => `
                  <tr class="contract-row" data-status="${c.status}">
                    ...
                    <td>
                      ...
                      <div class="text-muted text-sm"><i class="fa-solid fa-phone"></i> ${c.tel}</div>
                    </td>
